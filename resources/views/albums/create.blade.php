...
<div class="col-start-2">
    <form action="{{ route('albums.store') }}" method="POST" class="border border-b-amber-400 rounded flex flex-col p-3 m-0">
        ...
        <div class="form-group grid grid-cols-8 auto-cols-auto my-0.5 px-1">
            <label class="col-span-2" for="times_sold">Band ID:</label>
            <input class="col-span-5 border border-amber-600 rounded px-1" type="text" id="band_id" name="band_id" placeholder="band id">
        </div>
        <div class="my-1">
